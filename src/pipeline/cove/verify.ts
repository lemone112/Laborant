 ...
 *
 * NOTE: This is NOT a Temporal workflow — it is a pure async function called
 * from inside a Temporal Activity. Renamed from `workflow.ts` to avoid confusion.
 */
