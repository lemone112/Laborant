...
// ────────────────────────────────────────────────────────────────────────────────
// Note: Activity implementations live in reindex.activities.ts
// ────────────────────────────────────────────────────────────────────────────────
// The actual activity implementations (cloneOrUpdateRepo, runAstIndexer,
// syncToNeo4j, syncToQdrant) are in ./reindex.activities.ts.
// They are registered with the Temporal worker via the worker.ts entry point.
// This separation is required because activity implementations must NOT be
// imported inside a workflow file that runs in the Temporal sandbox.
